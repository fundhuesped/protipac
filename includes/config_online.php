...
//estados proyectos
define("ST_PRO_ABIERTO", "1");
define("ST_PRO_ENROLANDO", "7");
define("ST_PRO_FUTURO", "3");
define("ST_PRO_FINALIZADO", "4");
define("ST_PRO_SIN_ASIGNAR", "5");
define("ST_PRO_SUSPENDIDO", "6");

//estados paciente protocolo
define("ST_PP_SCR", "1");
define("ST_PP_PROTOCOLO", "3");
define("ST_PP_FALLOSCR", "4");
define("ST_PP_COMPLETADO", "5");
define("ST_PP_DISCONTINUADO", "6");
define("ST_PP_ACTIVO", "7");

//estados Visitas
define("ST_VIS_REALIZADA", "1");
define("ST_VIS_CANCELADA", "2");
define("ST_VIS_PROGRAMADA", "3");
...
//Tipos rol investigador
define('TIPO_INV_PRINCIPAL', '1');
define('TIPO_INV_SUB', '2');

//Tipos rol patrocinador
define('TIPO_ROL_FINANCIADOR', '3');
define('TIPO_ROL_SPONSOR', '2');
define('TIPO_ROL_CRO', '1');

//tipo visita
define('TIPO_VIS_SCR','1');
define('TIPO_VIS_BASAL','2');
define('TIPO_VIS_CONTROL','3');
define('TIPO_VIS_FOLLOW','4');
define('TIPO_VIS_ESPO','5');
...
if($_REQUEST['accion']=="LOGIN"){
	...
	//path sitio
	define('PATH', '/home/protipac/public_html/');
