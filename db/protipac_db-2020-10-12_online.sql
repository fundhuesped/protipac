...
-- Tiempo de generación: 12-10-2020 a las 13:00:11
...
CREATE TABLE `asset` (
  ...
  `ast_description` text COLLATE utf8_unicode_ci,
...
(22, 2, '', '', 1, '2020-09-10', '11:14:02', '2020-09-10', '11:14:02', 1, NULL, '190.16.24.37', NULL),
(24, 2, '', '', 1, '2020-09-10', '11:18:47', '2020-09-10', '11:18:47', 1, NULL, '190.16.24.37', NULL),
(25, 2, '', '', 1, '2020-09-10', '11:22:27', '2020-09-10', '11:22:27', 1, NULL, '152.170.242.33', NULL),
(26, 2, '', '', 1, '2020-09-25', '14:08:17', '2020-09-25', '14:08:17', 1, NULL, '186.136.217.159', NULL),
(27, 2, '', '', 1, '2020-10-02', '14:07:46', '2020-10-02', '14:07:46', 1, NULL, '190.245.6.154', NULL);
...
CREATE TABLE `assetcomment` (
  ...
  `com_message` text COLLATE utf8_unicode_ci,
...
(16, 23, 18, NULL, 13, 14, '', 80, 0, 4),
(17, 23, 11, NULL, 2, 2, '', 21, 0, 1),
(18, 23, -1, 'Control adicional', 3, 2, 'las que sean', 25, 1, 3),
(19, 28, 1, NULL, 4, 5, '', -30, 0, 1),
(20, 28, 2, NULL, 1, 1, 'dsfasd', 0, 1, 2),
(21, 28, 9, NULL, 4, 3, '', 7, 1, 3),
(22, 30, 1, NULL, 4, 5, '', -40, 1, 1),
(23, 30, 2, NULL, 2, 3, '', 0, 1, 2),
(24, 31, 1, NULL, 2, 2, '', -40, 1, 1),
(25, 31, 2, NULL, 1, 1, '', 0, 1, 2);
...
(34, NULL, 'instituto algo', NULL, NULL, NULL, NULL, NULL, NULL, '', 3),
(37, NULL, 'Nuevo sponsor', NULL, NULL, NULL, NULL, NULL, NULL, '', 3),
(38, NULL, 'Nueva CRO', NULL, NULL, NULL, NULL, NULL, NULL, '', 3),
(39, NULL, 'Financiado', NULL, NULL, NULL, NULL, NULL, NULL, '', 3),
(40, NULL, 'Financiador', NULL, NULL, NULL, NULL, NULL, NULL, '', 3);
...
CREATE TABLE `link` (
  ...
  `lnk_file_full_size` text COLLATE utf8_unicode_ci,
  `lnk_file_thumb_size` text COLLATE utf8_unicode_ci,
  `lnk_address` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `protocolo` (
  ...
  `pro_titulo` text COMMENT 'Descripción del estudio',
...
(23, 'protocolo prueba protipac', 'test proto v1', '435345 1', 44, 1, '2020-04-30', '2020-08-04', 1, 2, NULL, 1, 0, 1, NULL, 'safsdfaaaa', NULL, NULL, NULL, 19),
...
(26, 'jdsjflhds\r\ndsfhsdfhd', ' prueba de vacuna para la hepatitis', 'VACUNA', 3, 4, '2020-09-11', '2020-09-12', 1, 1, 2, 1, 0, 1, NULL, 'sdfsdf', NULL, NULL, NULL, 22),
(28, 'Probando carga de nuevo protocolo', 'Bet', 'Betiana ', 800, 5, '2020-09-01', '2020-09-30', 1, 1, 3, 1, 0, 1, NULL, 'Campo de contacto', NULL, NULL, NULL, 24),
(29, 'Probando carga nuevo protocolo', 'Bet', 'Betiana', 800, 5, '2020-09-01', '2020-09-30', 14, 1, 3, 1, 0, 1, NULL, 'Campo de contactos', NULL, NULL, NULL, 25),
(30, 'test', 'proto v8', 'proto v8', 445, 4, '2020-09-25', '2020-09-30', 1, 1, 2, 0, 0, 0, NULL, 'sdfsdf', NULL, NULL, NULL, 26),
(31, 'safsdf', 'proto v9', 'proto v9', 300, 2, '2020-10-02', '2021-04-08', 1, 1, 2, 0, 0, 0, NULL, 'sdfsdf', NULL, NULL, NULL, 27);
...
CREATE TABLE `protocolo_log` (
  ...
  `plog_comentario` text COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(35, 23, '2020-09-09 20:21:07', 1, 1, ''),
(37, 26, '2020-09-10 11:14:02', 1, 1, ''),
(39, 28, '2020-09-10 11:18:47', 1, 1, ''),
(40, 29, '2020-09-10 11:22:27', 1, 1, ''),
(41, 30, '2020-09-25 14:08:17', 1, 7, ''),
(42, 30, '2020-09-25 14:10:09', 1, 1, ''),
(43, 31, '2020-10-02 14:07:46', 1, 1, '');
...
(26, 1, '76', '656', NULL, 7, 2, NULL, NULL),
(28, 1, '456546', '4566546', NULL, 1, 2, 1, 0),
(30, 1, '5454', '', NULL, 1, 2, NULL, NULL),
(31, 1, '345435', '', NULL, 3, 2, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `protocolo_paciente_estado`
--

CREATE TABLE `protocolo_paciente_estado` (
  `ppe_pro_id` bigint(20) NOT NULL,
  `ppe_pac_id` bigint(20) NOT NULL,
  `ppe_fecha_estado` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `protocolo_paciente_log` (
  ...
  `ppaclog_pac_id` bigint(20) NOT NULL,
  `ppaclog_fecha_hora` datetime NOT NULL,
  `ppaclog_usr_id` bigint(20) NOT NULL,
  `ppaclog_spp_id` int(11) NOT NULL,
  `ppaclog_comentario` text COLLATE utf8_unicode_ci,
  `ppaclog_fecha_estado` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Volcado de datos para la tabla `protocolo_paciente_log`
--

INSERT INTO `protocolo_paciente_log` (`ppaclog_id`, `ppaclog_pro_id`, `ppaclog_pac_id`, `ppaclog_fecha_hora`, `ppaclog_usr_id`, `ppaclog_spp_id`, `ppaclog_comentario`, `ppaclog_fecha_estado`) VALUES
(1, 31, 1, '2020-10-02 15:02:16', 1, 1, 'Screening', '2020-10-02'),
(2, 31, 1, '2020-10-02 15:02:37', 1, 3, 'En protocolo', '2020-10-09');
...
CREATE TABLE `protocolo_paciente_visita` (
  ...
  `provis_fecha_agenda_original` datetime DEFAULT NULL,
  `provis_hora_agenda_original` time DEFAULT NULL,
...
INSERT INTO `protocolo_paciente_visita` (`provis_id`, `provis_pro_id`, `provis_pac_id`, `provis_cron_id`, `provis_descripcion`, `provis_fecha_agenda_original`, `provis_hora_agenda_original`, `provis_fecha_agenda`, `provis_hora_agenda`, `provis_fecha_realizada`, `provis_hora_realizada`, `provis_sv_id`, `provis_med_id`, `provis_tiv_id`, `provis_observaciones`, `provis_ventana_max`, `provis_ventana_min`, `provis_laboratorio`) VALUES
(1, 23, 1, 6, NULL, '2020-08-19 00:00:00', '10:00:00', '2020-08-19 00:00:00', '10:00:00', '2020-08-19 00:00:00', '10:14:00', 1, 1, 1, 'test', 8, 8, NULL),
(2, 23, 1, 7, NULL, '2020-08-26 00:00:00', NULL, '2020-08-26 00:00:00', NULL, '2020-08-26 00:00:00', NULL, 1, 1, 2, NULL, NULL, NULL, NULL),
(3, 24, 1, 8, NULL, '2020-08-01 00:00:00', '05:14:00', '2020-08-01 00:00:00', '05:14:00', '2020-08-01 00:00:00', '05:07:00', 1, 1, 1, '', 7, 7, NULL),
(4, 24, 1, 9, NULL, '2020-10-10 00:00:00', NULL, '2020-10-10 00:00:00', NULL, '2020-10-10 00:00:00', NULL, 1, 1, 2, NULL, NULL, NULL, NULL),
(15, 23, 1, NULL, 'Espontánea', '2020-08-28 00:00:00', '14:12:00', '2020-08-28 00:00:00', '14:12:00', NULL, NULL, 2, 2, 5, 'test 2', NULL, NULL, NULL),
(24, 25, 1, 14, NULL, '2020-08-27 00:00:00', '10:10:00', '2020-08-27 00:00:00', '10:10:00', '2020-08-28 00:00:00', '10:12:00', 1, 2, 1, '', 7, 7, NULL),
(25, 25, 1, 15, NULL, '2020-08-31 00:00:00', NULL, '2020-08-31 00:00:00', NULL, '2020-08-31 00:00:00', NULL, 1, 2, 2, NULL, 4, 4, NULL),
(26, 25, 1, NULL, 'Basal', '2020-09-02 00:00:00', '05:06:00', '2020-09-02 00:00:00', '05:06:00', NULL, NULL, 3, 2, 5, '', NULL, NULL, NULL),
(27, 26, 1, NULL, 'Espontánea', '2020-09-10 00:00:00', '11:12:00', '2020-09-10 00:00:00', '11:12:00', '2020-09-10 00:00:00', '12:12:00', 1, 2, 5, '', NULL, NULL, NULL),
(28, 28, 1, 19, NULL, '2020-09-22 00:00:00', NULL, '2020-09-22 00:00:00', NULL, '2020-09-22 00:00:00', NULL, 1, 2, 1, NULL, 4, 5, NULL),
(29, 28, 1, 20, NULL, '2020-09-30 00:00:00', NULL, '2020-09-30 00:00:00', NULL, NULL, NULL, 3, 2, 2, NULL, 1, 1, NULL),
(30, 30, 1, 22, NULL, '0000-00-00 00:00:00', NULL, '2020-09-29 00:00:00', NULL, '2020-09-29 00:00:00', NULL, 1, 2, 1, NULL, 4, 5, NULL),
(31, 31, 1, 24, NULL, '2020-10-02 00:00:00', NULL, '2020-10-02 00:00:00', NULL, '2020-10-02 00:00:00', NULL, 1, 2, 1, NULL, 2, 2, NULL),
(32, 31, 1, 25, NULL, '2020-11-11 00:00:00', NULL, '2020-11-11 00:00:00', NULL, '2020-10-09 00:00:00', NULL, 1, 2, 2, NULL, 1, 1, NULL);
...
(1, 1, 'adm', 'e10adc3949ba59abbe56e057f20f883e', 'Administrador', 'Dirección', 'laurayantonietti@gmail.com', 20181105, '15:17:00', 20201002, '1', 2, NULL, NULL, NULL);
...
--
-- Indices de la tabla `protocolo_paciente_estado`
--
ALTER TABLE `protocolo_paciente_estado`
  ADD PRIMARY KEY (`ppe_pro_id`,`ppe_pac_id`),
  ADD KEY `ppe_pac_id` (`ppe_pac_id`,`ppe_pro_id`);
...
ALTER TABLE `protocolo_paciente_log`
  ...
  ADD KEY `ppaclog_pac_id` (`ppaclog_pac_id`,`ppaclog_pro_id`);
...
--
ALTER TABLE `asset`
  MODIFY `ast_id` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `cronograma_visita`
  MODIFY `cron_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `empresa`
  MODIFY `emp_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `function`
  MODIFY `fnc_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `protocolo`
  MODIFY `pro_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT de la tabla `protocolo_log`
--
ALTER TABLE `protocolo_log`
  MODIFY `plog_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT de la tabla `protocolo_paciente_log`
--
ALTER TABLE `protocolo_paciente_log`
  MODIFY `ppaclog_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `protocolo_paciente_visita`
--
ALTER TABLE `protocolo_paciente_visita`
  MODIFY `provis_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `role_function`
  MODIFY `rfu_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=197;
...
--
-- Filtros para la tabla `protocolo_paciente_estado`
--
ALTER TABLE `protocolo_paciente_estado`
  ADD CONSTRAINT `protocolo_paciente_estado_ibfk_1` FOREIGN KEY (`ppe_pac_id`,`ppe_pro_id`) REFERENCES `protocolo_paciente` (`propac_pac_id`, `propac_pro_id`);

--
-- Filtros para la tabla `protocolo_paciente_log`
--
ALTER TABLE `protocolo_paciente_log`
  ADD CONSTRAINT `protocolo_paciente_log_ibfk_1` FOREIGN KEY (`ppaclog_pac_id`) REFERENCES `paciente` (`pac_id`),
  ADD CONSTRAINT `protocolo_paciente_log_ibfk_2` FOREIGN KEY (`ppaclog_pro_id`) REFERENCES `protocolo` (`pro_id`);
...
ALTER TABLE `protocolo_paciente_visita`
  ...
  ADD CONSTRAINT `protocolo_paciente_visita_ibfk_8` FOREIGN KEY (`provis_pac_id`,`provis_pro_id`) REFERENCES `protocolo_paciente` (`propac_pac_id`, `propac_pro_id`);
